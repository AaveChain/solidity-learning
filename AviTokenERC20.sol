...
//MY token launch on locally and metamask(Ropsten) also........
...
contract AKT is IERC20 {

    string public constant name = "AVI_ERC20";
   ...
   constructor() {
    ...
    //     return true;
    // }
    // function burnToken(address owner,uint _value) public returns(bool){
    //     require(msg.sender==_owner,"only admin has this acess");
    //     totalSupply_-=_value;
    //     balances[_owner]-=_value;
